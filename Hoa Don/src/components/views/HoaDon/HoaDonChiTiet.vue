            ...
            <div class="timeline-container position-relative py-3">
              ...
              <div class="d-flex justify-content-between">
                ...
                >
                  ...
                  <div class="timeline-date small text-muted" v-if="currentStatus >= step.step && step.step === 1">
            ...
            <div class="card border-0 shadow-sm rounded-3 h-100">
              <div class="card-body p-4">
                ...
                <div class="d-flex justify-content-between mb-3 border-bottom pb-2">
                  ...
                  <span class="fw-bold text-dark">{{ invoice.ten_nguoi_nhan || 'Khách vãng lai' }}</span>
                </div>
                <div class="d-flex justify-content-between mb-3 border-bottom pb-2">
        ...
        <div class="card border-0 shadow-sm rounded-3 flex-grow-1">
          <div class="card-body p-4 d-flex flex-column">
            ...
            <div class="d-flex justify-content-between mb-3 flex-grow-1">
              ...
              <div class="text-end">
                <span class="fw-bold" :class="invoice.ngay_tt_thuc_te ? 'text-brown' : 'text-danger'">
